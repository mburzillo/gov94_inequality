...
duplicate_but_missing_cities <- c("Colorado SpringsCO","DurhamNC", "FresnoCA", "RaleighNC", 
                      "TucsonAZ", "TuscaloosaAL", "West Palm BeachFL", "BeaumontTX",
                      "PensacolaFL","GreenvilleSC")

missing_all <- c(missing_cities, duplicate_but_missing_cities)

hp_mayors %>%
  filter(cityst == "WilmingtonNC")

other_race = c("asian", "hispanic", "white")

hp_mayors_sub <- hp_mayors %>%
  filter(cityst %in% missing_all) %>%
...
duplicate_cities <- c("AmarilloTX", "AuroraIL", "ChesterPA", 
                      ...
                      "LaredoTX", "LubbockTX", "MaconGA", "MadisonWI", "MonroeLA", "OrlandoFL",
